...
local function IsOwnMessage(Message)
    return Message:match("Pulse") or Message:match("BallEvent") or Message:match("AutoTime") 
        or Message:match("DunkChanger") or Message:match("AutoSteal") or Message:match("Walkspeed")
        or Message:match("BallValues") or Message:match("BallFunctions") or Message:match("ShootingGui")
        or Message:match("ReplicatedStorage") or Message:match("TeleportService") or Message:match("MarketplaceService")
        or Message:match("getProductInfo") or Message:match("GetProductInfo") or Message:match("VirtualInputManager")
        or Message:match("cloneref") or Message:match("security purposes") or Message:match("Obsidian")
        or Message:match("Basketball Stars") or Message:match("stacktrace45")
end
